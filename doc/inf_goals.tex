...
For example
\href{http://cplint.lamping.unife.it/example/inference/pcfglr.pl}{\texttt{pcfglr.pl}} and \href{http://cplint.lamping.unife.it/example/inference/plcg.pl}{\texttt{plcg.pl}} satisfy this constraint while
