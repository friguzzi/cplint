...
\verb|pita| and |mcintyre| support causal reasoning, i.e., computing the effect of actions using the
...
with the directive \verb|:- action predicate1/arity1,...,predicaten/arityn.|
...
do term) and actions and observations can be freely mixed.
