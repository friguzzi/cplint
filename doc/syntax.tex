...
See for example \href{http://cplint.eu/example/inference/gauss_mean_est_user.pl}{\texttt{gauss\_mean\_est\_user.pl}} and
\href{http://cplint.eu/example/inference/binomial_user.pl}{\texttt{binomial\_user.pl}}.
