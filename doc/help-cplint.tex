...
In LPADs, you write in the editor the program without the library import and the \verb|:- cplint| and \verb|:- end_cplint.| compiler directives. \verb|pita| is used for inference.
