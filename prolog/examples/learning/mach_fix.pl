...
determination(fix/0,replaceable/1).
determination(fix/0,not_replaceable/1).
determination(fix/0,worn/1).
determination(fix/0,not_worn/1).
determination(fix/0,none_worn/0).
